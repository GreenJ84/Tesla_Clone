...
export const LogRegHeader = () => {
  ...
  return (
    <NavContainer>
      ...
      <SideMenu>
        <p
          className="cursor bg-transparent hover:bg-[rgba(220,220,220,.5)] transition-colors duration-700 pl-1 pr-1 py-4 text-lg text-black font-semibold rounded-[6px]"
        >
